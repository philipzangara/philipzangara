...
| [🔎 Simple PCAP Extractor](https://github.com/philipzangara/simple-pcap-extractor) | Python-based PCAP parser for extracting network metadata and HTTP file artifacts from capture files |
